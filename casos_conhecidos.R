...
# Deputado Celso Maldener, que apresentou 12 notas fiscais de refeições consumidas em um único dia e em um unico estabelecimento, em valores que variam entre R$23,00 e R$87.78, totalizando R$ 727,78.
maldener <- d %>%
...
hiran <- d %>% 
  filter(txNomeParlamentar=='HIRAN GONÇALVES' & txtCNPJCPF=='13182427000108')
...
!!!Tentar consertar esses registros repetidos
!!!Tentar incluir info sobre cnpj e sobre total de gastos no dia
